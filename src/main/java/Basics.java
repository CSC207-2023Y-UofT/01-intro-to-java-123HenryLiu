...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        String[] wordSplit = to_split.split(" ");

        ret.append(wordSplit[0].charAt(0));
        ret.append(wordSplit[1].charAt(0));
        ret.append(wordSplit[2].charAt(0));
        ret.append(wordSplit[3].charAt(0));
        ret.append(wordSplit[4].charAt(0));
        ret.append(wordSplit[5].charAt(0));
        ret.append(wordSplit[6].charAt(0));
